...
EventLoop.prototype.eventLoopCore = function(block) {
    ...
    var runInfo = this.runInfo,
        ...
        untilDate = block ? $.NSDate('distantFuture') : null, // or objc.NSDate('distantPast') to not block
    ...
    try {
        ...
        do {
            ...
            event = app('nextEventMatchingMask',
                $.NSAnyEventMask,//.toString(), // …grumble… uint64 as string …grumble… // UNGRUMBLE BECAUSE THIS HAS BEEN FIXED
                'untilDate', untilDate,
                'inMode', inMode,
                'dequeue', 1)
